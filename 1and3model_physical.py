...
wavelength = 0.78 # microns
NEURON_SIZE = 16 # 3x3 scatterers/neuron, periodicity is 1.2
LAYER_SIZE =  NEURON_SIZE*N
LAYER_SPACING = 100000# 10 cm
detector_width = 800*wavelength
DEBUG_MODE = 1
...
outputs2 = inverse_physical_nonlinearity(outputs1)

outputs2 = propagator_inside_NN.propagate_tf_fft(outputs2)
print('layer 1 propagated')

#measured_im = measurement_layer(outputsf, batch_size, N, 3)
measured_im = np.abs(outputs2)**2
normalized_im = normalize_output_2(measured_im,N)*10
print('norm',normalized_im)
